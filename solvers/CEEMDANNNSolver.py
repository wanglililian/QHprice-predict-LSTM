...
from models.CEEMDANNN import CEEMDANNN
...
class CEEMDANNNSolver(BasicSolver):
    def __init__(self, args):
        super(CEEMDANNNSolver, self).__init__(args)
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_encoder_token, batch_decoder_token, batch_encoder_temporal, batch_decoder_temporal,
                ...
                if self.args.task == 'Regression':
                    ...
                    mse_loss0 = self.criterion(outputs[:,:,0],batch_label[:,:,0])
