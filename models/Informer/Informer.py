...
class Informer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len,
                 ...
                 dropout=0.0, attn='prob', embed='fixed', frequence='minute', activation='gelu',
        ...
        # Encoding
        self.enc_embedding = DataEmbedding(enc_in, d_model, embed, frequence, dropout)
        self.dec_embedding = DataEmbedding(dec_in, d_model, embed, frequence, dropout)
        # Attention
